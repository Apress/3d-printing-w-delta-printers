...
def calculate_delta(cartesian):
  ...
  #print "Calculations:"
  #print "  > sqrt({0} - sq({1} - {2}) - sq({3} - {4})) + {5}".format(
  #  DELTA_DIAGONAL_ROD_2, DELTA_TOWER1_X, cartesian[X_AXIS],
  #  DELTA_TOWER1_Y, cartesian[Y_AXIS], cartesian[Z_AXIS]
  #)
  #x = DELTA_TOWER1_X-cartesian[X_AXIS]
  #y = DELTA_TOWER1_Y-cartesian[Y_AXIS]
  #print "  > sqrt({0} - sq({1}) - sq({2})) + {3}".format(
  #  DELTA_DIAGONAL_ROD_2, x, y, cartesian[Z_AXIS]
  #)
  #x = sq(DELTA_TOWER1_X-cartesian[X_AXIS])
  #y = sq(DELTA_TOWER1_Y-cartesian[Y_AXIS])
  #print "  > sqrt({0} - {1} - {2}) + {3}".format(
  #  DELTA_DIAGONAL_ROD_2, x, y, cartesian[Z_AXIS]
  #)
  #s = math.sqrt(DELTA_DIAGONAL_ROD_2
  #              - sq(DELTA_TOWER1_X-cartesian[X_AXIS])
  #              - sq(DELTA_TOWER1_Y-cartesian[Y_AXIS])
  #             )
  #print "  > {0} + {1}".format(s, cartesian[Z_AXIS])
  #s = s + cartesian[Z_AXIS]
  #print "  > {0}".format(s)
...
difference[X_AXIS] = current_pos[X_AXIS] - delta[X_AXIS]
difference[Y_AXIS] = current_pos[Y_AXIS] - delta[Y_AXIS]
difference[Z_AXIS] = current_pos[Z_AXIS] - delta[Z_AXIS]
print "Difference:"
